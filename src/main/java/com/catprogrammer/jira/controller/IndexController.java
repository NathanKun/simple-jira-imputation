...
public class IndexController {
    ...
    public String index(Model model,
            ...
            @RequestParam(value = "type", required = false, defaultValue = "jsrender") String type) {
        
        if (type.equals("thymeleaf")) {
            ...
            model.addAttribute("jsrender", false);
            ...
            model.addAttribute("jsrender", true);
            return "index";
        }
    }
}
